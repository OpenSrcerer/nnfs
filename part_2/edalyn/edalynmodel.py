...
from part_2.edalyn.layers.input import Layer_Input
from part_2.edalyn.losses.cat_x_entropy import Loss_CategoricalCrossentropy
from part_2.edalyn.losses.softmax_cat_x_entropy import Activation_Softmax_Loss_CategoricalCrossentropy
...
class EdalynModel:
    ...
    # Add multiple layers for the model
